    ...
    def generate(
        ...
        **kwargs,
        ...
        if images is not None:
            ...
            (_inputs, position_ids, attention_mask, _, inputs_embeds, _) = self.prepare_inputs_labels_for_multimodal(inputs, position_ids, attention_mask, None, None, images, modalities, image_sizes=image_sizes)
        else:
        ...
        if not mask_infer:
            ...
            return super().generate_prompt_mask_kl_approx(
                inputs_embeds=inputs_embeds,
